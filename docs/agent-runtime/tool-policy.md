# Tool Policy -- dev-frame-opencode

> Bootstrap: 2026-06-11 | Phase: 0-5 | Platform: Both | Template v1.0

## Permitted Operations

| Operation | Condition |
|-----------|-----------|
| Read files | Within D:\dev-frame-opencode |
| List directories | Within D:\dev-frame-opencode |
